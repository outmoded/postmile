...
exports.auth = function (request, reply) {
    ...
    var finalizedLogin = function (account) {
        ...
        if (request.auth.isAuthenticated &&
            ...
            exports.loginCall(account.network, account.id, request, destination, account, reply);
        }
    };
...
exports.emailToken = function (request, reply) {
    ...
    exports.loginCall('email', request.params.token, request, null, null, reply);
};


// Login common function

exports.loginCall = function (type, id, request, destination, account, reply) {
