...
exports.get = {
    ...
    handler: function (request) {
        ...
        exports.load(request.params.id, request.auth.credentials.user, false, function (err, project, member) {
...
exports.list = {
    ...
    handler: function (request) {
        ...
        Sort.list('project', request.auth.credentials.user, 'participants.id', function (err, projects) {
            ...
            Last.load(request.auth.credentials.user, function (err, last) {
...
exports.post = {
    ...
    handler: function (request) {
        ...
        exports.load(request.params.id, request.auth.credentials.user, true, function (err, project, member) {
            ...
            if (Object.keys(request.payload).length > 0) {
                ...
                Sort.set('project', request.auth.credentials.user, 'participants.id', request.params.id, request.query.position, function (err) {
...
exports.put = {
    ...
    handler: function (request) {
        ...
        Db.insert('project', project, function (err, items) {
            ...
            Stream.update({ object: 'projects', user: request.auth.credentials.user }, request);
            return request.reply({ status: 'ok', id: items[0]._id })
            ...
            if (exports.isOwner(project, request.auth.credentials.user)) {
                ...
                Task.delProject(project._id, function (err) {
                    ...
                    Db.remove('project', project._id, function (err) {
                        ...
                        Last.delProject(request.auth.credentials.user, project._id, function (err) { });
                        Stream.update({ object: 'project', project: project._id }, request);
...
exports.suggestions = {
    ...
    handler: function (request) {
        ...
        exports.load(request.params.id, request.auth.credentials.user, false, function (err, project, member) {
            ...
            Suggestions.list(project, request.auth.credentials.user, function (err, results) {
        ...
        var process = function () {
            ...
            exports.load(request.params.id, request.auth.credentials.user, true, function (err, project, member) {
                ...
                if (request.payload.participants) {
                    ...
                    User.load(request.auth.credentials.user, function (err, user) {
...
exports.join = {
    ...
    handler: function (request) {
        ...
        exports.load(request.params.id, request.auth.credentials.user, false, function (err, project, member) {
            ...
            Db.updateCriteria('project', project._id, { 'participants.id': request.auth.credentials.user }, { $unset: { 'participants.$.isPending': 1 } }, function (err) {
