...
var server = new Hapi.Server(Config.host.api.domain, Config.host.api.port, { cors: true });
...
server.pack.allow({ ext: true }).require({ good: null, scarecrow: scarecrow }, function (err) {
