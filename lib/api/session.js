...
exports.validateMessage = function (message, authorization, callback) {

    var credentialsFunc = Oz.server.credentialsFunc(Vault.ozTicket.password, {});
    Oz.hawk.server.authenticateMessage(Config.server.api.host, Config.server.api.port, message, authorization, credentialsFunc, {}, function (err, credentials) {
