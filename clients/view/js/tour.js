...
var guideContent = [
	...
	{ title: 'Sled details', text: 'If your sled is an event or if it has a location, you can use the date, time, and place options to keep that information. Use these fields as you wish. They are just for keeping track and sharing information with the other participants. These detail are about the entire sled, not any individual item.', style: { top: 77, left: 10, height: 22, width: 560} },
	...
	{ title: 'Got feedback?', text: 'You\'ve reached the end of the tour. We hope you\'ll find Sled useful and fun. If you have questions or suggestions, please use the feedback link to let us know. You can launch this tour again from the Account menu.', style: { top: -35, right: -10, height: 16, width: 110} }
];
...
Y.namespace("sled").tour  = {	// export it
};
